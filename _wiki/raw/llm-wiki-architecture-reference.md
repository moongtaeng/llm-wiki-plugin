...
# llm-wiki skill: architecture reference (skills/llm-wiki/references/architecture.md)

(Verbatim copy of the plugin's own `skills/llm-wiki/references/architecture.md` at commit-time, collected as a raw ingest source for the dogfood wiki. See the live file in the plugin source for the canonical, always-current version.)
